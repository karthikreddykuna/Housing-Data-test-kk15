...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/karthikreddykuna/Housing-Data-test-kk15/master/prepared_data.csv')
...
encoder_location = 'https://github.com/karthikreddykuna/Housing-Data-test-kk15/blob/master/encoder.pkl?raw=true'
